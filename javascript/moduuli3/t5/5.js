...
for (const key in picArray) {
  if (picArray.hasOwnProperty(key)) {
    const article = document.createElement('article');
    article.className = 'card';
    const h2 = document.createElement('h2');
    h2.textContent = picArray[key].title;
    article.appendChild(h2);
    const figure = document.createElement('figure');
    const image = document.createElement('img');
    image.src = picArray[key].image.medium;
    image.alt = picArray[key].title;
    figure.appendChild(image);
    const figcaption = document.createElement('figcaption');
    figcaption.textContent = picArray[key].caption;
    figure.appendChild(figcaption);
    article.appendChild(figure);
    const p = document.createElement('p');
    p.textContent = picArray[key].description;
